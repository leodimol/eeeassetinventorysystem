              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                  ...
                  <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="glass-card-modern p-4 flex flex-col justify-center overflow-hidden">
                      <p className="text-[10px] font-bold uppercase tracking-normal truncate" title="Total Assets" style={{ color: 'var(--text-tertiary)' }}>Total Assets</p>
                      <p className="text-2xl font-black" style={{ color: 'var(--text-primary)' }}>{dashboardStats.total}</p>
                    </div>
                    <div className="glass-card-modern p-4 flex flex-col justify-center overflow-hidden">
                      <p className="text-[10px] font-bold uppercase tracking-normal truncate" title="Active" style={{ color: 'var(--text-tertiary)' }}>Active</p>
                      <p className="text-2xl font-black" style={{ color: 'var(--accent-green)' }}>{dashboardStats.active}</p>
                    </div>
                    <div className="glass-card-modern p-4 flex flex-col justify-center overflow-hidden">
                      <p className="text-[10px] font-bold uppercase tracking-normal truncate" title="Maintenance" style={{ color: 'var(--text-tertiary)' }}>Maintenance</p>
                      <p className="text-2xl font-black" style={{ color: 'var(--accent-orange)' }}>{dashboardStats.maintenance}</p>
                    </div>
                    <div className="glass-card-modern p-4 flex flex-col justify-center overflow-hidden">
                      <p className="text-[10px] font-bold uppercase tracking-normal truncate" title="Retired" style={{ color: 'var(--text-tertiary)' }}>Retired</p>
